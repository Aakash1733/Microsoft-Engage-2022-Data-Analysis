...
df = pd.read_csv('static/cars.csv')
 #data clean
...
comdata = pd.read_csv("static/Comm.csv")
...
df_1 = pd.read_csv('static/data.csv')
...
,template='plotly_dark', width=600, height=800)
 ...
 df4 = pd.read_csv("static/segment.csv")
 ...
 india_states = json.load(open('static/states_india.geojson'))
 df3 = pd.read_csv("static/statesales2019.csv")
